    ...
    >
      ...
      <div className="text-white w-full md:w-[70vw] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6  ">
        {projects.map(({ name, description, tech, code, preview }) => (
          <div
            key={name}
            className="flex flex-col items-center border border-[#202020] rounded-xl p-4 py-6 shadow-md hover:shadow-2xl hover:shadow-shadow group min-h-40 bg-bg shadow-shadow  hover:-translate-y-3 transition duration-300"
          >
