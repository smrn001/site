    ...
    >
      ...
      <div className="flex flex-row space-x-3">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="bg-transparent border dark:border-[#202020] border-[#eeeeee] rounded-md dark:text-white text-black min-w-24 shadow-md  dark:hover:shadow-xl hover:shadow-xl dark:hover:shadow-shadow hover:shadow-[#eeeeee]  dark:shadow-shadow shadow-[#eeeeee]  px-6 py-3 hover:-translate-y-1 transition transition-duration-400"
          >
            {skill}
          </div>
        ))}
